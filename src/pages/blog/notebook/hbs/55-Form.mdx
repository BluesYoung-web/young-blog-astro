...
tableData:
  ...
  - cmd: fontsize
    value: 1~7
    des: 将选中文本改为指定字体大小(反向对应 <strong>h 标签</strong>)
  - cmd: forecolor
    value: 颜色字符串
    des: 将选中文本改为指定的颜色
  - cmd: formatblock
    value: '<code>HTML</code> 标签，如<code>h1</code>'
    des: 将选中文本包含在指定的 <code>HTML</code> 标签中
  - cmd: indent
    value: 'null'
    des: 缩进光标所在行
  - cmd: inserthorizontalrule
    value: 'null'
    des: '在光标位置插入 <code>hr</code> 元素'
  - cmd: insertimage
    value: 图片地址
    des: 在光标位置插入图片
  - cmd: insertorderedlist
    value: 'null'
    des: '在光标位置插入 <code>ol</code> 元素'
  - cmd: insertparagraph
    value: 'null'
    des: '在光标位置插入 <code>p</code> 元素'
  - cmd: insertunorderedlist
    value: 'null'
    des: '在光标位置插入 <code>ul</code> 元素'
  - cmd: italic
    value: 'null'
    des: 切换选中文本的斜体样式
  - cmd: justifycenter
  ...
  - cmd: removeformat
    value: 'null'
    des: 移除包含光标所在位置块的 <code>HTML</code> 标签
  - cmd: selectall
    value: 'null'
    des: 选中文档中的所有文本
  - cmd: underline
